                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.shipping methods')}}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('edit.shippings.method','inner')}}">{{__('admin/sidebar.inner method')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shippings.method','outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('admin/sidebar.outer method')}}</a>
                            </li>
